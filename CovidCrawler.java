...
public class CovidCrawler {
    ...
    public static void main(String[] args) throws FileNotFoundException, IOException {
        ...
        //the seed
        toCrawl.add("https://www.npr.org/sections/coronavirus-live-updates/");
                ...
                if (!linksCrawled.contains(URL)) {
                    ...
                    for (Element page : linksOnPage) {
                        if (page.attr("abs:href").startsWith("https")
                                && page.attr("abs:href").contains("npr.org")
                                && page.attr("abs:href").contains("covid")){
...
//            System.err.println("For '" + URL + "': " + e.getMessage());
        ...
        PrintWriter matrix = new PrintWriter("NPR_Matrix.txt");
        PrintWriter pages = new PrintWriter("NPR_Pages.txt");
